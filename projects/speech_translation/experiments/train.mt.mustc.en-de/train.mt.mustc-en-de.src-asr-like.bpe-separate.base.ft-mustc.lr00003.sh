...
MODEL_NAME=src-asr-like.bpe-separate.base.ft-mustc.lr00003
GROUP_NAME=mt.mustc.en-de

FAIRSEQ_PATH=/work/smt4/gao/tran/speech_translation/fairseq
DATA_PATH=/work/smt4/gao/tran/speech_translation/datasets/text/out/parnia.mustc-mt.en-de.32k.src-normalized.ft-mustc/data-bin
...
--finetune-from-model /work/smt4/gao/tran/speech_translation/trained_models/mt.mustc.en-de/src-asr-like.bpe-separate.base.fix/checkpoints/checkpoint_best.pt
EOF
