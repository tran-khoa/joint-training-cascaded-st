...
MODEL_NAME=src-asr-like.asr-bpe.mustc-only
GROUP_NAME=mt.mustc.en-de

FAIRSEQ_PATH=/work/smt4/gao/tran/speech_translation/fairseq
DATA_PATH=/work/smt4/gao/tran/speech_translation/datasets/text/manual/parnia.mustc-mt.ft.en-de.fair-asr-bpe.src-normalized/data-bin
...
if [ $NUM_GPUS -eq 1 ]; then
  ...
  WANDB_RUN_GROUP=$GROUP_NAME WANDB_NAME=$MODEL_NAME python -m torch.distributed.launch --nproc_per_node=$NUM_GPUS --master_port 29504 \
