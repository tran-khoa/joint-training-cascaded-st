...
MODEL_NAME=src-asr-like.asr-bpe.base.ft-mustc.lr0003
GROUP_NAME=mt.mustc.en-de

FAIRSEQ_PATH=/work/smt4/gao/tran/speech_translation/fairseq
DATA_PATH=/work/smt4/gao/tran/speech_translation/datasets/text/manual/parnia.mustc-mt.ft.en-de.asr-bpe.src-normalized/data-bin
...
--finetune-from-model /work/smt4/gao/tran/speech_translation/trained_models/mt.mustc.en-de/src-asr-like.asr-bpe.base/checkpoints/checkpoint_best.pt
EOF
