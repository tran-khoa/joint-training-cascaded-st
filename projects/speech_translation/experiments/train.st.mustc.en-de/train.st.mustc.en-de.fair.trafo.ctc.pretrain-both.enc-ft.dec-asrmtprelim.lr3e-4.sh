...
MODEL_NAME=fair.trafo.ctc.pretrain-both.enc-ft.dec-asrmtprelim-lr3e-4
...
--load-pretrained-decoder-from /work/smt4/gao/tran/speech_translation/final_models/mustc.en-de/mt.asr-bpe.prelim.pt \
