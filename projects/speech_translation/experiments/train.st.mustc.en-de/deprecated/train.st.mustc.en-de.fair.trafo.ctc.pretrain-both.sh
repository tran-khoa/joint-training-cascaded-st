...
MODEL_NAME=fair.trafo.ctc.pretrain-both
...
--dropout 0.1 \
--load-pretrained-encoder-from /work/smt4/gao/tran/speech_translation/trained_models/asr.mustc.en-de/fair.trafo.ctc/checkpoints/checkpoint_best.pt \
