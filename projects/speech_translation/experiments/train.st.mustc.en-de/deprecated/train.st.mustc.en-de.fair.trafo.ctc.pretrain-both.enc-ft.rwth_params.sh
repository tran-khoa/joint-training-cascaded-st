...
MODEL_NAME=fair.trafo.ctc.pretrain-both.enc-ft.rwth_params
...
--lr 0.0008 \
--warmup-subepochs 10 --warmup-init-lr 0.0003 --min-lr 1.6e-05 \
--lr-scheduler subepoch_reduce_lr_on_plateau --lr-shrink 0.9 --lr-threshold 5e-3 --lr-patience 6 \
--weight-decay 0.0001 \
--update-freq 8 \
--batch-size 200 \
--max-tokens 5000 \
