...
MODEL_NAME=joint-seq.mustc.en-de.base.multitask.inversesqrt.fix.lr3e-6
...
--asr-model-conf $USER_DIR/experiments/train.joint-seq.mustc.en-de/asr.base.ft.yaml \
--mt-model-conf $USER_DIR/experiments/train.joint-seq.mustc.en-de/mt.base.yaml \
--criterion joint_cascaded_st \
--auxiliary-task-weight-schedule inverse_sqrt \
...
--mt-checkpoint /work/smt4/gao/tran/speech_translation/trained_models/mt.mustc.en-de/src-asr-like.bpe-separate.base.fix/checkpoints/checkpoint_best.pt \
...
--train-subset train_st,train_asr_ft2021,train \
--valid-subset dev_st \
