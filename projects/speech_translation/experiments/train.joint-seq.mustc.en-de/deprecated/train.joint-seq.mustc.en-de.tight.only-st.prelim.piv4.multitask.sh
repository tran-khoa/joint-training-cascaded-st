...
MODEL_NAME=joint-seq.mustc.en-de.tight.only-st.prelim.piv4.multitask
...
--mt-checkpoint /work/smt4/gao/tran/speech_translation/final_models/mustc.en-de/mt.asr-bpe.prelim.pt \
--tight-integrated \
...
--lr 0.00003 \
--warmup-subepochs 10 \
--lr-scheduler subepoch_reduce_lr_on_plateau --lr-shrink 0.8 --lr-threshold 5e-3 --lr-patience 5 \
--weight-decay 0.0001 \
--update-freq 8 \
--batch-size 50 \
--max-tokens 4000 \
