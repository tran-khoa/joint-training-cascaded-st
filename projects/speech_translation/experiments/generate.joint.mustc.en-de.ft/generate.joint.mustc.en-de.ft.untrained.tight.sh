...
--model-overrides {'asr_model_conf':'$USER_DIR/experiments/train.joint-seq.mustc.en-de/asr.base.ft.yaml','mt_model_conf':'$USER_DIR/experiments/train.joint-seq.mustc.en-de/mt.base.yaml','tight_integrated':True,'tight_integrated_decoding_temp':1.5} \
