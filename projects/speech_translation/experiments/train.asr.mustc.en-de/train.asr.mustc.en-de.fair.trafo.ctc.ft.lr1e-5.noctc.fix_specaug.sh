...
MODEL_NAME=fair.ctc.ft.lr1e-5.noctc.fix_specaug
...
--log-format simple \
--log-interval 100 \
--finetune-from-model /work/smt4/gao/tran/speech_translation/trained_models/asr.mustc.en-de/fair.trafo.ctc/checkpoints/checkpoint_best.pt
EOF
