...
--lr-scheduler subepoch_reduce_lr_on_plateau --lr-shrink 0.9 --lr-threshold 5e-3 --lr-patience 5 --min-lr 1.6e-05 \
--update-freq 8 \
--batch-size 200 \
--max-tokens 10000 \
--max-epoch 100 \
