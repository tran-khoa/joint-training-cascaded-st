...
MODEL_NAME=joint.mustc.en-de.noft.piv1.lr3e-6
GROUP_NAME=joint.mustc.en-de.noft
TAGS=joint,piv1,nomulti,lr3e-6
...
if [ "$NUM_GPUS" -eq 1 ]; then
  ...
  WANDB_TAGS=$TAGS WANDB_RUN_GROUP=$GROUP_NAME WANDB_NAME=$MODEL_NAME python -m torch.distributed.launch --nproc_per_node=$NUM_GPUS --master_port 29500 \
