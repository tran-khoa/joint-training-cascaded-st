...
MODEL_NAME=joint.mustc.en-de.noft.untrained
...
--model-overrides {'asr_model_conf':'$USER_DIR/experiments/train.joint.mustc.en-de.noft/asr.base.noft.yaml','mt_model_conf':'$USER_DIR/experiments/train.joint-seq.mustc.en-de/mt.base.yaml'} \
